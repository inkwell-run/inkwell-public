...
// ../../node_modules/.pnpm/react-inspector@6.0.1_react@18.2.0/node_modules/react-inspector/dist/index.mjs
...
var ThemeContext = (0, import_react5.createContext)(createTheme(themes_exports[DEFAULT_THEME_NAME]));
...
var TreeNode = (0, import_react4.memo)((props) => {
  props = {
    expanded: true,
  ...
  }, "\xA0"), import_react4.default.createElement(NodeRenderer, {
    ...props
...
var ConnectedTreeNode = (0, import_react2.memo)((props) => {
...
var ObjectValue = ({ object, styles }) => {
  ...
  switch (typeof object) {
    ...
    case "function":
      ...
      }, "\u0192\xA0"), import_react9.default.createElement("span", {
...
var ObjectPreview = ({ data }) => {
  ...
  if (Array.isArray(object)) {
    ...
    }, arrayLength === 0 ? `` : `(${arrayLength})\xA0`), import_react8.default.createElement("span", {
    ...
    for (const propertyName in object) {
      if (hasOwnProperty.call(object, propertyName)) {
        ...
        propertyNodes.push(import_react8.default.createElement("span", {
          ...
          name: propertyName || `""`
        }), ":\xA0", import_react8.default.createElement(ObjectValue, {
...
var SortIconContainer = (props) => import_react14.default.createElement("div", {
  style: {
    position: "absolute",
    top: 1,
    right: 0,
...
var HeaderContainer = ({
  ...
  }, indexColumnText), columns.map((column) => import_react13.default.createElement(TH, {
...
var Inspector = ({ table = false, data, ...rest }) => {
  if (table) {
    return import_react17.default.createElement(themedTableInspector, {
      data,
      ...rest
    });
  }
  if ((0, import_is_dom.default)(data))
    return import_react17.default.createElement(themedDOMInspector, {
      data,
      ...rest
    });
  return import_react17.default.createElement(themedObjectInspector, {
    data,
    ...rest
  });
};
